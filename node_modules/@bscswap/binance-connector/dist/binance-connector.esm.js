...
var NoEthereumProviderError = /*#__PURE__*/function (_Error) {
  ...
  function NoEthereumProviderError() {
    ...
    _this.message = 'No Binance Wallet provider was found on window.BinanceChain.';
    return _this;
  }
...
var BinanceConnector = /*#__PURE__*/function (_AbstractConnector) {
  _inheritsLoose(BinanceConnector, _AbstractConnector);

  function BinanceConnector(kwargs) {
    var _this3;
  ...
  var _proto = BinanceConnector.prototype;
  ...
  _proto.activate = function activate() {
    try {
      var _temp5 = function _temp5(_result) {
        ...
        var _temp = function () {
          if (!account) {
            ...
            return Promise.resolve(window.BinanceChain.enable().then(function (sendReturn) {
              return sendReturn && parseSendReturn(sendReturn)[0];
            })).then(function (_window$BinanceChain$2) {
              account = _window$BinanceChain$2;
            });
          }
        }();
      ...
      if (window.BinanceChain.on) {
        window.BinanceChain.on('chainChanged', _this5.handleChainChanged);
        window.BinanceChain.on('accountsChanged', _this5.handleAccountsChanged);
        window.BinanceChain.on('close', _this5.handleClose);
        window.BinanceChain.on('networkChanged', _this5.handleNetworkChanged);
      ...
      var _temp6 = _catch(function () {
        return Promise.resolve(window.BinanceChain.send('eth_requestAccounts').then(function (sendReturn) {
          return parseSendReturn(sendReturn)[0];
        })).then(function (_window$BinanceChain$) {
          account = _window$BinanceChain$;
        });
      }, function (error) {
        if (error.code === 4001) {
  ...
  _proto.getChainId = function getChainId() {
    try {
        ...
        var _temp8 = function () {
          if (!chainId) {
            var _temp14 = _catch(function () {
              return Promise.resolve(window.BinanceChain.send('net_version').then(parseSendReturn)).then(function (_window$BinanceChain$4) {
                chainId = _window$BinanceChain$4;
              });
            }, function () {
      ...
      var _temp13 = _catch(function () {
        return Promise.resolve(window.BinanceChain.send('eth_chainId').then(parseSendReturn)).then(function (_window$BinanceChain$3) {
          chainId = _window$BinanceChain$3;
        });
      }, function () {
  ...
  _proto.getAccount = function getAccount() {
    try {
        ...
        var _temp16 = function () {
          if (!account) {
            var _temp22 = _catch(function () {
              return Promise.resolve(window.BinanceChain.enable().then(function (sendReturn) {
                return parseSendReturn(sendReturn)[0];
              })).then(function (_window$BinanceChain$6) {
                account = _window$BinanceChain$6;
              });
            }, function () {
      ...
      var _temp21 = _catch(function () {
        return Promise.resolve(window.BinanceChain.send('eth_accounts').then(function (sendReturn) {
          return parseSendReturn(sendReturn)[0];
        })).then(function (_window$BinanceChain$5) {
          account = _window$BinanceChain$5;
        });
      }, function () {
...
export { BinanceConnector, NoEthereumProviderError, UserRejectedRequestError };
//# sourceMappingURL=binance-connector.esm.js.map
